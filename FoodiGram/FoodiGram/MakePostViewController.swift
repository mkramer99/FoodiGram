...
class MakePostViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    @IBOutlet weak var restaurantCommentField: UITextField!
    ...
    override func viewDidLoad() {
        ...
        restaurantCommentField.text = "Write a description!"
    }
    ...
    @IBAction func saveButtonAction() {
        ...
        newPost.setValue(restaurantCommentField.text, forKey: "comment")
        do {
